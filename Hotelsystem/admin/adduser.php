    ...
    <div class="dashboard-content-wrap">
                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title font-size-30">Add User <span><a href="./users.php"><button class="btn btn-warning">View Users</button></a></span></h2>     
                            </div>
        ...
        <form action="addprocess.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="btn-box">
                        <button class="theme-btn" type="submit">Add User</button>
                    </div>
                </div><!-- end col-lg-12 -->
            </div><!-- end row -->
        </form>
