...
<section class="dashboard-area">
    ...
    <div class="dashboard-content-wrap">
                    ...
                    <div class="col-lg-6">
                        <div class="breadcrumb-content">
                            <div class="section-heading">
                                <h2 class="sec__title font-size-30">Add Rooms <span><a href="./room.php"><button class="btn btn-warning">View Room</button></a></span></h2>     
                            </div>
        ...
        <input type="hidden" value="" name="addroom" required>

        <label class="label-text">Upload Images</label>
        ...
        <br>
            ...
            <div class="row">
                <div class="col-lg-12 responsive-column">
                    <div class="input-box">
                        ...
                        <div class="form-group">
                            <input class="form-control" name="roomname" type="text" value="" required>
                        </div>
                    </div>
                </div><!-- end col-lg-12 -->
                <div class="col-lg-12 responsive-column">
                    <div class="input-box">
                        ...
                        <div class="form-group">
                        <textarea class="form-control" class="form-control" name="content" required></textarea>
                        </div>
                    </div>
                </div><!-- end col-lg-12 -->
                ...
                <div class="col-lg-12 responsive-column">
                    <div class="input-box">
                        <label class="label-text">Price (Le)</label>
                        <div class="form-group">
                ...
                <div class="col-lg-12 responsive-column">
                    <div class="input-box">
                        <label class="label-text">Services(Seperate by Comma)</label>
                        <div class="form-group">
                        <input class="form-control" type="text" value="" name="services" required>
                        </div>
                    </div>
                </div><!-- end col-lg-12 -->
                <div class="col-lg-12 responsive-column">
                    <div class="input-box">
                        <label class="label-text">Amenities(Seperate by Comma)</label>
                        <div class="form-group">
                        <input class="form-control" type="text" value="" name="amenities" required>
                        </div>
                    </div>
                </div><!-- end col-lg-12 -->
                ...
                <div class="col-lg-12">
                    <div class="btn-box">
                        <button class="theme-btn" type="submit">Add Room</button>
                    </div>
                </div><!-- end col-lg-12 -->
            </div><!-- end row -->
        </form>
